...
export function AnalysisStatus({ isAnalyzing, isCompleted }: AnalysisStatusProps) {
...
export function AnalysisCharacter({ isAnalyzing, isCompleted }: AnalysisStatusProps) {
  if (isAnalyzing) {
    return (
