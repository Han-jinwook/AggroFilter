...
// REFACTORED_BY_MERLIN_HUB: t_users ?åÎ¶º ?§Ï†ï ??app_aggro_profiles.f_notify_settings ?¥Í? ?àÏ†ï
export const runtime = 'nodejs';

const VALID_KEYS = ['f_notify_grade_change', 'f_notify_ranking_change', 'f_notify_top10_change'] as const;

/**
 * GET: ?¨Ïö©?êÏùò ?åÎ¶º ?§Ï†ï Ï°∞Ìöå (3Í∞?Ï°∞Í±¥Î≥?ON/OFF)
...
/**
 * PUT: ?åÎ¶º Ï°∞Í±¥Î≥??†Í? Î≥ÄÍ≤? * Body: { email, key, enabled }
