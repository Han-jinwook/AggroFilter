...
const mockRealtimeVideos: RealtimeVideo[] = [
  {
    id: '1',
    date: '25.02.07',
...
const mockRealtimeChannels: RealtimeChannel[] = [
  {
    id: '1',
    date: '25.02.18',
...
const channelVideos: { [key: string]: RealtimeVideo[] } = {
  '1': [ // 백종원 PAIK JONG WON
    {
      id: 'v1',
      date: '25.02.05',
...
export default function RealtimeBestPage() {
  ...
  const handleChannelPressStart = () => {
    ...
    longPressTimerRef.current = setTimeout(() => {
      ...
      router.push('/ranking?tab=realtime_channel')
    }, 500)
  }
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0 border-l-2 border-slate-200 pl-3">
                    <Link href={`/result?from=real-time-best&tab=videos`} className="block">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-slate-600">
                      ...
                      <Link href="/ranking?tab=realtime_video" className="flex items-center gap-1.5 hover:opacity-80">
                        <Image
                  ...
                  {expandedChannelId === channel.id && channelVideos[channel.id] && (
                    <div className="mt-1 space-y-1 rounded-xl bg-slate-50 p-2">
                      {channelVideos[channel.id].map((video) => (
                        <Link
                          key={video.id}
                          href={`/result?from=real-time-best&tab=channels`}
