...
- **챕터 개수 유동성 (매우 중요)**: 예시 데이터가 2~3개의 챕터라고 해서 무조건 똑같이 고정하지 마라. 또한 무조건 5개로 맞추려는 기계적인 분할도 절대 금지한다. 영상 길이에 비례하여 유동적으로 분할하라 (예: 3~5분짜리 짧은 영상은 2~3개, 10분은 5~7개, 30분짜리 긴 영상은 10~15개 이상).
