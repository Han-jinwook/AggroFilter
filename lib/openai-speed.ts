...
- 'topic' 작성 규칙: "외국인 자금 이동"처럼 건조한 명사구로 적지 마라. 반드시 시청자의 호기심과 긴장감을 극대화하는 '질문형'으로 작성하라. (예: "외국인이 대탈출 후 향하는 '여기'는 어디?", "이번 주 터진다는 '무시무시한 일'의 정체는?")
- 'text' 작성 규칙: 질문형 topic에 대한 해답(배경 설명)을 설명글 속에 자연스럽게 녹여내고, 마지막에 반드시 "[진짜 정답] XXX" 형식으로 팩트를 돌직구로 밝혀라.
