...
- 'text' 길이 및 구조 (매우 중요): 절대 1줄로 짧게 대답하지 마라! 유튜버가 왜 그런 주장을 했는지, 어떤 논리와 배경이 있는지 '2~5문장 분량'으로 상세하고 풍성하게 설명(빌드업)을 해라. 그리고 텍스트의 **맨 마지막**에 반드시 "[스포] XXX" 형식으로 최종 정답(팩트)을 돌직구로 밝혀라.
